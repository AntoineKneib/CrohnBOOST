...
![CrohnBOOST Logo](Resources/Icons/CrohnSegment.png)
...
- **Creeping fat segmentation** from DIXON sequences
- **Interactive refinement** with adjustment sliders
- **Quantitative analysis** for clinical research
